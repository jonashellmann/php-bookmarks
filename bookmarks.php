...
<?php
$select_categorys = $db->query("SELECT id, name FROM categorys WHERE user_id = " . $userid);
$categorys = $select_categorys->fetchAll();
...
if( isset($_POST["create-category"]) ) {
	try {
		if ($_POST["category-parent"] === "-") {
			$sql = $db->prepare("INSERT INTO categorys (name, user_id) VALUES (:name, :user_id)");
			...
			$sql = $db->prepare("INSERT INTO categorys (name, parent_id, user_id) VALUES (:name, :parent_id, :user_id)");
			$sql->bindParam(":name", $name);
